...
<div class="container">
  ...
  <header>
    <nav class="secondary_header" id="menu">
		...
		<ul>
			<li style="padding-right: 17%;"><img onclick="location.href=''" src="https://cdn.discordapp.com/attachments/697470483813367821/777322385799774208/DGpalette.png" style="width:200%;"></li>
		</ul>
	<div>
